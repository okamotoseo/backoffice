                    ...
                    <div class="card">
                        <table class="table table-sm m-0">
                            <tbody>
                                <tr>
                                    <th>Pedido:</th>
                                    <td><?php echo $remetente->getPedido(); ?></td>
                                    <th>Unidade:</th>
                                    <td>AGF Coronel Galdino</td>
                                    <th>Registro</th>
                                    <td></td>
                                </tr>
                            </tbody>
                    ...
                    <table class="table table-sm table-bordered m-0">
                        <thead>
                            <tr class="thead-light">
                                <th colspan="4" class="text-center">Identificação dos Bens</th>
                            </tr>
                            <tr>
                        ...
                        <tbody>
                            ...
                            <?php foreach ($itens->getItens() as $item) : ?>
                                <tr>
                                    <td class="text-left"><?php echo $item->getDescricao(); ?></td>
                                    <td class="text-center"><?php echo $item->getQuantidade(); ?></td>
                                    <td class="text-center"><?php echo $item->getPeso(); ?></td>
                                    <td class="text-center"><?php echo $item->getValor(); ?></td>
                                </tr>
                            <?php endforeach; ?>
                            <tr>
                                <td class="text-right" colspan="3">Valor Total</td>
                                <td class="text-center"><?php echo 'R$ ' . $valorTotal; ?></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
