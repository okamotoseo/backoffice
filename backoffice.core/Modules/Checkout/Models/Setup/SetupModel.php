...
class SetupModel 
{
	...
	public function Save(){
	    ...
	    $db_check_setup = $this->db->query (
	        'SELECT * FROM `module_checkout` WHERE store_id = ?',
	        array($this->store_id)
	        );
	    ...
	    if ( ! empty( $storeId ) ) {
	        $query = $this->db->update('module_checkout', 'store_id', $storeId, array(
	        ...
	        $query = $this->db->insert('module_checkout', array(
	...
	public function Load()
	{
        ...
        if(!empty($this->store_id)){
            ...
            $query = $this->db->query('SELECT * FROM module_checkout WHERE `store_id`= ?', array( $this->store_id ) );
