	...
	<div class="col-md-12">
        ...
        <div class="nav-tabs-custom">
            ...
            <ul class="nav nav-tabs">
                ...
                <li class="<?php echo $tabs['publications']; ?>"><a href="#tab_5" data-toggle='tab'>Publicações</a></li>
                <li class="dropdown">
                 ...
                 <li class="pull-right <?php echo $tabs['log']; ?> text-muted"><a href="#tab_6" data-toggle='tab'><i class="fa fa-code"></i> Log</a></li>
            </ul>
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="col-md-2">
                                    	<div class="form-group <?php echo $availableProductModel->field_error['ean']; ?>">
                                    		<label>Ean:</label>
                                    		<?php if(empty( $availableProductModel->ean) AND !empty( $availableProductModel->id)){ ?>
                                    			<small class='text-muted pull-right' id='generate_ean' product_id='<?php echo $availableProductModel->id; ?>'> <i class='fa  fa-bolt' data-toggle='tooltip' title='Gerar EAN' ></i></small>
                                    		<?php }?>
...
//                                 		        $disabled = 'false';
            ...
            <?php } ?>
                ...
                <div class='tab-pane <?php echo $tabs['publications']; ?>' id='tab_5'>
                	<div class='row'>
    					<div class="col-md-12">
...
//                             		   $disabled = 'disabled';
                ...
                <div class="tab-pane <?php echo $tabs['log']; ?>" id='tab_6'>
	                <div class='row'>
		                <div class="col-md-12">
