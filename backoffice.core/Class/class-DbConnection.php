...
/**
 * Masterxml - Classe para gerenciamento da base de dados
 *
 * @package masterxml
 * @since 0.1
 */
...
//         print_r($insert);die;
     ...
     * @return object|bool Retorna a consulta ou falso
     */
    public function updateOld( $table, $where_field, $where_field_value, $values ) {
    ...
    public function update( $table, $where_field, $where_field_value, $values ) {
        ...
        // Configura o array de valores
        $set = array();
        $where_field = is_array($where_field) ? $where_field : array($where_field);
        $where_field_value = is_array($where_field_value) ? $where_field_value : array($where_field_value);
        $where = " WHERE";
